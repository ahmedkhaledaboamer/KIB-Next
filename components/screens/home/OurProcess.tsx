...
type StepKey = "consultation" | "caseEvaluation" | "strategicPlanning";
    ...
    >
      ...
      <div className="relative z-10 flex items-center min-h-screen">
        <div className="container mx-auto px-4 lg:px-12 py-20">
          ...
          {/* Steps */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-[clamp(1.5rem,3vw,3rem)] mx-auto">
            {steps.map((step, index) => {
              ...
              const lineHeight =
                index === 0 ? "h-24" : index === 1 ? "h-32" : "h-40";
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="group relative h-full rounded-2xl bg-slate-800/60 backdrop-blur-sm p-8 border border-slate-700/50 transition-all duration-300 hover:-translate-y-2 hover:bg-slate-800/80 hover:border-teal-500/30 hover:shadow-2xl hover:shadow-teal-500/10">
                      ...
                      <p className="text-gray-200 leading-relaxed text-[clamp(0.95rem,1.3vw,2rem)]">
                        {step.description}
                      </p>
                    </div>
                  </article>
