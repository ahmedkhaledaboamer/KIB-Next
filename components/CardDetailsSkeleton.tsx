"use client"; // مهم جدًا لـ Next.js 16

import React from "react";

export default function CardDetailsSkeleton() {
  return (
    <div className="relative w-full h-full rounded-[28px] overflow-hidden bg-white shadow-[0_10px_40px_rgba(0,0,0,0.08)] animate-pulse">
